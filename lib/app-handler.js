...
const { sendTestDiamondStatusAlert, sendCoachRequestSubmittedEmail, sendCoachRequestDecisionEmail, sendOpponentChangeEmail, sendOpponentChangeFailureEmail, smtpConfigured } = require('./diamond-status-monitor');
