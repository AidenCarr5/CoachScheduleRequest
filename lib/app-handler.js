...
const { applyApprovedRequest, updateGameOpponent, updateDiamondStatus, assignGameOfficial, removeGameOfficial, listTournamentScoreGames, submitTournamentScore, getTournamentBracketData } = require('./turtle-club-client');
